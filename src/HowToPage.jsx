...
const NAVIGATION_CALLOUTS = [
  ...
  { marker: "C", label: "Choose an Asia-Pacific reporting economy and whether the importer or exporter reported the trade.", left: "60%", top: "28.5%", width: "37.7%", height: "18%" },
...
const FILTER_DEFINITIONS = [{
  ...
  items: [
    ...
    { term: "Reporting economy", description: "Shows trade reported by the selected Asia-Pacific economy. All Asia-Pacific reporters combines data from economies with available reports." },

...
const NAVIGATION_CALLOUTS = [
  ...
  { marker: "C", label: "Set the Asia-Pacific reporting economy and choose imports or exports.", left: "63.6%", top: "28%", width: "35.1%", height: "20%" },
...
const FILTER_DEFINITIONS = [{
  ...
  items: [
    ...
    { term: "Economy", description: "Shows the selected Asia-Pacific economy’s trade. All Asia-Pacific economies combines the reporting economies with available data." },
    { term: "Trade flow", description: "Imports shows purchases reported for Asia-Pacific economies; Exports shows their reported sales to destinations worldwide." },
...
const SNAPSHOT_DEFINITIONS = [{
  ...
  items: [
    { term: "Reported imports or exports", description: "The full annual current-US-dollar value for the selected products and Asia-Pacific reporting economies." },
    { term: "Direct or mirror estimate", description: "Direct identifies data from the reporting economy. Mirror estimate identifies a value reconstructed from partner reports when direct data are unavailable." },
    ...
    <GuidanceShell footer="Sources: ITC Trade Map and United Nations Comtrade annual merchandise trade data.">
      <div className="page howto-page">
        <header className="howto-heading">
          ...
          <p>
            Use the Trade Flow Explorer to examine Asia-Pacific trade with worldwide
            partners. Use the EV Value Chain to compare global trade across related
            production stages.
          </p>
        </header>
        ...
        >
          <p>
            ...
            HS codes. The selected economy and trade flow apply across the Trade
            Flow Explorer. Clear the product selection to return to the no-data state,
            or use Reset to restore the default view.
          </p>
          <p>
            Imports and exports are separate views and can differ. Choose the trade flow
            that fits the question rather than combining the two.
          </p>
        </GuideSection>
        ...
        >
          <p>
            ...
            a displayed route. The table identifies each route as a direct observation,
            a mirror estimate or a combination of sources.
          </p>
          <p>
